...
async function logOpenAiTokens(
...
app.get(
  "/api/signature-envelope/public/:token",
...
app.get("/api/contract/stats", auth, (req, res) =>
  relayToNode(req, res, "/contract/stats"),
);
app.get("/api/contract/deadlines", auth, (req, res) =>
  relayToNode(req, res, withQuery("/contract/deadlines", req)),
);
app.get("/api/contract/export.csv", auth, (req, res) =>
  relayToNodeRaw(req, res, withQuery("/contract/export.csv", req)),
);
app.get("/api/contract/tags", auth, (req, res) =>
  relayToNode(req, res, "/contract/tags"),
);
app.post("/api/contract/tags", auth, (req, res) =>
  relayToNode(req, res, "/contract/tags"),
);
app.delete("/api/contract/tags/:externalId", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/tags/${encodeURIComponent(req.params.externalId as string)}`,
  ),
);
app.get("/api/contract/folders", auth, (req, res) =>
  relayToNode(req, res, "/contract/folders"),
);
app.post("/api/contract/folders", auth, (req, res) =>
  relayToNode(req, res, "/contract/folders"),
);
app.delete("/api/contract/folders/:externalId", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/folders/${encodeURIComponent(req.params.externalId as string)}`,
  ),
);
...
app.get("/api/contract/:externalId/document", auth, (req, res) =>
  relayToNodeRaw(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/document`,
  ),
);
app.get("/api/contract/:externalId/audit", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/audit`,
  ),
);
app.post("/api/contract/:externalId/validate-field", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/validate-field`,
  ),
);
app.post("/api/contract/:externalId/amendment", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/amendment`,
  ),
);
app.post("/api/contract/:externalId/version", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/version`,
  ),
);
app.post("/api/contract/:externalId/snapshot", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/snapshot`,
  ),
);
app.post("/api/contract/:externalId/archive", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/archive`,
  ),
);
// Négociation — commentaires + approbation (/comments/ avant /:externalId)
app.post("/api/contract/:externalId/comments", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/comments`,
  ),
);
app.post("/api/contract/:externalId/approval", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}/approval`,
  ),
);
app.delete("/api/contract/comments/:commentId", auth, (req, res) =>
  relayToNode(
    req,
    res,
...
app.patch("/api/contract/comments/:commentId/resolve", auth, (req, res) =>
  relayToNode(
    req,
    res,
...
app.get("/api/contract/:externalId", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}`,
  ),
);
app.patch("/api/contract/:externalId", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}`,
...
app.delete("/api/contract/:externalId", auth, (req, res) =>
  relayToNode(
    req,
    res,
    `/contract/${encodeURIComponent(req.params.externalId as string)}`,
