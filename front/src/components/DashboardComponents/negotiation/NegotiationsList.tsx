...
export function NegotiationsList() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold text-ink tracking-tight">Négociation</h1>
      ...
      {items.length === 0 ? (
        <div className="bg-white rounded-card border border-line shadow-card px-6 py-14 flex flex-col items-center gap-4 text-center">
          ...
          {items.map((n) => {
            ...
            return (
              <button
                ...
                className="w-full text-left bg-white rounded-card border border-line shadow-card px-5 py-4 hover:border-brand/40 transition-all group"
              >
