...
export const ContextualAnalysisForm: React.FC<ContextualAnalysisFormProps> = ({
    ...
    const performDetection = async () => {
      ...
      try {
        ...
        if (isActive) {
          ...
          console.log(
            "✅ Pré-remplissage 100% IA effectué - aucune variable statique utilisée",
          );
        }
      } catch (error) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const contextToSubmit = {
      ...
      missionContext:
        context.mission || placeholders.mission || "Analyse contractuelle",
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setContext({ ...context, contractType: e.target.value })
              }
          ...
          {isEquitable && (
            <div className="p-3 mb-4 bg-green-50 border border-green-300 text-green-800 rounded-md text-sm">
              ⚖️ Contrat équilibré détecté : la position contractuelle est
              neutre.
            </div>
          )}
          ...
          {!isEquitable && (
            <div>
              <label className="block text-sm font-medium mb-2">
                Quelle est votre position contractuelle ? :
              </label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContext({
                        ...
                        interestOrientation: "assertive",
                      })
                    }
                    className="text-blue-600"
                  />
                  <span className="text-sm">
                    <span className="font-medium">🏛️ Position favorable</span> -
                    J'ai l'avantage contractuel
                  </span>
                </label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContext({
                        ...context,
                        userRole: e.target.value,
                        interestOrientation: "defensive",
                      })
                    }
                    className="text-green-600"
                  />
                  <span className="text-sm">
                    <span className="font-medium">🛡️ Position vulnérable</span>{" "}
                    - Je suis en situation de faiblesse
                  </span>
                </label>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setContext({
                      ...context,
                      interestOrientation: e.target.value as
                        | "defensive"
                        | "balanced"
                        | "assertive",
                    })
                ...
                />
                <span className="text-sm">
                  <span className="font-medium">🛡️ Défensif</span> - Protéger
                  mes intérêts, identifier tous les risques
                </span>
              </label>
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm">
                  <span className="font-medium">⚖️ Équilibré</span> - Analyse
                  objective des deux parties
                </span>
              </label>
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm">
                  <span className="font-medium">⚡ Assertif</span> - Maximiser
                  mes avantages contractuels
                </span>
              </label>
            </div>
          ...
          */}
          <div>
            <label htmlFor="legalRegim" className="block text-sm font-medium">
              Régime Juridique :
            </label>
            ...
            <input
              ...
              name="legalRegim"
              onChange={(e) =>
                setContext((prev) => ({ ...prev, legalRegime: e.target.value }))
              }
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setContext((prev) => ({
                  ...prev,
                  contractObjective: e.target.value,
                }))
              }
              required
            />
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                setContext((prev) => ({ ...prev, mission: e.target.value }))
              }
              placeholder={
                placeholders.mission ||
                getMissionPlaceholder(context.contractType)
              }
